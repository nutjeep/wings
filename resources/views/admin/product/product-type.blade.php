...
@section('content')
    ...
    <div class="col-12">
      <div class="card shadow">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Jenis Produk</h6>
        </div>
        <div class="card-body">
                ...
                @foreach ($productType as $item)
                  <tr>
                    ...
                    <td class="d-flex flex-wrap">
                      ...
                      <form action="{{ route('delete.product.type', $item->id) }}" method="post">
                        @method('delete')
                        @csrf
  ...
  <div class="modal fade" id="add" tabindex="-1" aria-labelledby="addLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <form action="{{ route('store.product.type') }}" method="post">
          @csrf
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="name" placeholder="Ex: Elektronik">
            </div>
          </div>
  ...
  @foreach ($productType as $item)
    <div class="modal fade" id="update_{{ $item->id }}" tabindex="-1" aria-labelledby="updateLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form action="{{ route('update.product.type', $item->id) }}" method="post">
            @csrf
            <div class="modal-header">
